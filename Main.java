...
class Main {
  ...
  public static void main(String[] args) { 
    ...
    delay();
    System.out.println("My name is Mr. Jagodzinski!");
    delay();
    ...
    sc.nextLine();
    System.out.print("\033[H\033[2J");
    System.out.println("Coach Witt: Why weren't you at practice? Physics club? Likely story.");
    delay();
    ...
    if (wins == 1) {
      ...
      sc.nextLine();
      System.out.print("\033[H\033[2J");
      System.out.println("Mr. White: If I win, I get to take another point off of your test! It makes me feel so good!");
      delay();
    ...
    if (wins == 2) {
      ...
      sc.nextLine();
      System.out.print("\033[H\033[2J");
      System.out.println("Mr. Jaggedzinski: Hey, you said my name wrong!");
      delay();
